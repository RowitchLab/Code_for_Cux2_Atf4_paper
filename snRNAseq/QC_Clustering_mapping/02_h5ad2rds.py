...
def convert_h5ad_to_rds(h5ad_path: str, rds_path: str, save_coords=False,normalize=False):
    """
    AnnData -> Seurat .rds
...
if __name__ == "__main__":
    ...
    output_rds = '/Users/xuz3/single_cell_python/Cux2_Atf4_paper_code/Atf4/data/processed/13_desc_v03.rds'
    convert_h5ad_to_rds(input_h5ad, output_rds,save_coords=True,normalize=True)
